...
public class ConnDB {
    ...
    private static boolean emptyWallet(){
        if(!ConnDB.wallet_folder.exists()){
            return false;
        }

        String[] content = ConnDB.wallet_folder.list();
    ...
    static {
        ...
        try {
            // Verifica que el driver JDBC de Oracle se encuentre.
